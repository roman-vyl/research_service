...
- [x] 1.1 Add `BatchSideSummary` (`trades`, `net_pnl`, `return_pct`,
      `win_rate | None`, `profit_factor | None`) to
      `application/experiments/contracts.py`.
- [x] 1.2 Extend `BatchCandidateResult` with `return_pct`,
